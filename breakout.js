...
var ASM_CONSTS = {
 ...
 93102: () => { return parseInt(Module.canvas.style.width); },  
 ...
 93380: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93513: () => { return window.innerWidth; },  
 93539: () => { return window.innerHeight; },  
 93566: () => { if (document.fullscreenElement) return 1; },  
 93612: () => { return Module.canvas.width; },  
 93644: () => { return parseInt(Module.canvas.style.width); },  
 93692: () => { if (document.fullscreenElement) return 1; },  
 93738: () => { return Module.canvas.width; },  
 93770: () => { return screen.width; },  
 93795: () => { return window.innerWidth; },  
 93821: () => { return window.innerHeight; },  
 93848: () => { if (document.fullscreenElement) return 1; },  
 93894: () => { return Module.canvas.width; },  
 93926: () => { return screen.width; },  
 93951: () => { document.exitFullscreen(); },  
 93978: () => { if (document.fullscreenElement) return 1; },  
 94024: () => { return Module.canvas.width; },  
 94056: () => { return parseInt(Module.canvas.style.width); },  
 94104: () => { document.exitFullscreen(); },  
 94131: ($0) => { Module.canvas.style.opacity = $0; },  
 94169: () => { return screen.width; },  
 94194: () => { return screen.height; },  
 94220: () => { return window.screenX; },  
 94247: () => { return window.screenY; },  
 94274: () => { return window.devicePixelRatio; },  
 94310: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94363: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94414: () => { Module.canvas.style.cursor = 'none'; },  
 94451: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94707: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94758: () => { if (document.pointerLockElement) return 1; },  
 94805: () => { if (document.fullscreenElement) return 1; },  
 94851: () => { return window.innerWidth; },  
 94877: () => { return window.innerHeight; }
};
