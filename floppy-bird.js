...
var ASM_CONSTS = {
  103952: () => { if (document.fullscreenElement) return 1; },
 103998: () => { return Module.canvas.width; },
 104030: () => { return parseInt(Module.canvas.style.width); },
 104078: () => { document.exitFullscreen(); },
 104105: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },
 104178: () => { if (document.fullscreenElement) return 1; },
 104224: () => { return Module.canvas.width; },
 104256: () => { return screen.width; },
 104281: () => { document.exitFullscreen(); },
 104308: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },
 104441: () => { return window.innerWidth; },
 104467: () => { return window.innerHeight; },
 104494: () => { if (document.fullscreenElement) return 1; },
 104540: () => { return Module.canvas.width; },
 104572: () => { return parseInt(Module.canvas.style.width); },
 104620: () => { if (document.fullscreenElement) return 1; },
 104666: () => { return Module.canvas.width; },
 104698: () => { return screen.width; },
 104723: () => { return window.innerWidth; },
 104749: () => { return window.innerHeight; },
 104776: () => { if (document.fullscreenElement) return 1; },
 104822: () => { return Module.canvas.width; },
 104854: () => { return screen.width; },
 104879: () => { document.exitFullscreen(); },
 104906: () => { if (document.fullscreenElement) return 1; },
 104952: () => { return Module.canvas.width; },
 104984: () => { return parseInt(Module.canvas.style.width); },
 105032: () => { document.exitFullscreen(); },
 105059: ($0) => { Module.canvas.style.opacity = $0; },
 105097: () => { return screen.width; },
 105122: () => { return screen.height; },
 105148: () => { return window.screenX; },
 105175: () => { return window.screenY; },
 105202: () => { return window.devicePixelRatio; },
 105238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },
 105291: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },
 105342: () => { Module.canvas.style.cursor = 'none'; },
 105379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },
 105635: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },
 105686: () => { if (document.pointerLockElement) return 1; },
 105733: () => { if (document.fullscreenElement) return 1; },
 105779: () => { return window.innerWidth; },
 105805: () => { return window.innerHeight; }
};
